...
@click.option(
    ...
    help="Pipeline to train and deploy the model. Choose from 'deploy', 'predict', or 'deploy_and_predict'.",
)
@click.option(
    "--min-accuracy",
    default=0.92,
...
def run_deployment(config: str,min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path="/home/mahesh/mlopsproject/data/olist_customers_dataset1.csv",
